...
Startuply = {
    stickyOptions: {
        ...
        onInit: function() {
            stickyMenuLogo = new Image();
            stickyMenuLogo.src = Startuply.stickyMenuLogo;

            stickyMenuLogoRetina = new Image();
            stickyMenuLogoRetina.src = Startuply.stickyMenuLogoRetina;

            stickyMenuLogo.onload = function() {
                $('.fixmenu-clone .logo img').not('.retina').attr('src', Startuply.stickyMenuLogo);
                $('.fixmenu-clone .logo img').not('.retina').attr('width', this.width);
                $('.fixmenu-clone .logo img').not('.retina').attr('height', this.height);
            };

            stickyMenuLogoRetina.onload = function() {
                $('.fixmenu-clone .logo img.retina').attr('src', Startuply.stickyMenuLogo);
                $('.fixmenu-clone .logo img.retina').attr('width', this.width);
                $('.fixmenu-clone .logo img.retina').attr('height', this.height);
            };
    ...
    getThemeOptions: function () {
        ...
        _this.stickyOptions.offset = ( typeof themeOptions != 'undefined' && themeOptions.menuPosition ) ? + themeOptions.menuPosition : 600;
